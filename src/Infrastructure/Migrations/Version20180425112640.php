 ...
 */
class Version20180425112640 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__users AS SELECT id, name, employee_code, nif, social_security, phone_number, image, days_available_holidays, days_debts_request, date_first_ctt, date_old, date_expiration_ctt, date_possible_renovation FROM users');
        $this->addSql('DROP TABLE users');
        $this->addSql('CREATE TABLE users (id INTEGER NOT NULL, name CLOB NOT NULL COLLATE BINARY, employee_code INTEGER NOT NULL, nif VARCHAR(255) NOT NULL COLLATE BINARY, social_security INTEGER NOT NULL, image VARCHAR(255) NOT NULL COLLATE BINARY, days_available_holidays INTEGER NOT NULL, days_debts_request INTEGER NOT NULL, date_first_ctt VARCHAR(255) NOT NULL COLLATE BINARY, date_old VARCHAR(255) NOT NULL COLLATE BINARY, date_expiration_ctt VARCHAR(255) NOT NULL COLLATE BINARY, date_possible_renovation VARCHAR(255) NOT NULL COLLATE BINARY, phone_number INTEGER DEFAULT NULL, department_id INTEGER NOT NULL, sub_department_id INTEGER DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO users (id, name, employee_code, nif, social_security, phone_number, image, days_available_holidays, days_debts_request, date_first_ctt, date_old, date_expiration_ctt, date_possible_renovation) SELECT id, name, employee_code, nif, social_security, phone_number, image, days_available_holidays, days_debts_request, date_first_ctt, date_old, date_expiration_ctt, date_possible_renovation FROM __temp__users');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE __temp__user_sizes');
        $this->addSql('CREATE INDEX IDX_545C7C31271E85C0 ON user_sizes (clothes_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__users AS SELECT id, name, employee_code, nif, social_security, phone_number, image, date_first_ctt, date_old, date_expiration_ctt, date_possible_renovation, days_available_holidays, days_debts_request FROM users');
        $this->addSql('DROP TABLE users');
        $this->addSql('CREATE TABLE users (id INTEGER NOT NULL, name CLOB NOT NULL, employee_code INTEGER NOT NULL, nif VARCHAR(255) NOT NULL, social_security INTEGER NOT NULL, image VARCHAR(255) NOT NULL, date_first_ctt VARCHAR(255) NOT NULL, date_old VARCHAR(255) NOT NULL, date_expiration_ctt VARCHAR(255) NOT NULL, date_possible_renovation VARCHAR(255) NOT NULL, days_available_holidays INTEGER NOT NULL, days_debts_request INTEGER NOT NULL, phone_number INTEGER NOT NULL, department VARCHAR(255) DEFAULT NULL COLLATE BINARY, sub_department VARCHAR(255) DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO users (id, name, employee_code, nif, social_security, phone_number, image, date_first_ctt, date_old, date_expiration_ctt, date_possible_renovation, days_available_holidays, days_debts_request) SELECT id, name, employee_code, nif, social_security, phone_number, image, date_first_ctt, date_old, date_expiration_ctt, date_possible_renovation, days_available_holidays, days_debts_request FROM __temp__users');
        $this->addSql('DROP TABLE __temp__users');
    }
}
